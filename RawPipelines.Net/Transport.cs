...
namespace RawPipelines.Net
{
    public class Transport
    {
        ...
        public event EventHandler<Connection> ConnectionStarting;
        ...
        public async Task<SocketError> ConnectAsync(IPEndPoint endPoint)
        {
            Debug.Assert(endPoint != null);
        ...
        private void Start(Socket socket)
        {
            ...
            ConnectionStarting?.Invoke(this, connection);
        }
    }
}